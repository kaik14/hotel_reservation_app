  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: IndexedStack(
        ...
        children: [
          SearchPage(), // re-created
          _servicePage, // cached
          _bookingPage, // cached
          _infoPage, // cached
          ProfilePage(), // re-created
        ],
      ),
...
class _ModernBottomBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final items = const [
      ...
      _NavItem('Service', Icons.room_service_rounded),
      _NavItem('Booking', Icons.calendar_today_rounded),
